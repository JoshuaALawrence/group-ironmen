...
export class PlayerEquipment extends BaseElement {
  emptySlotImages: Record<number, string>;
  playerName: string | null;
  slotEls: Record<number, HTMLElement | null>;
  ...
  connectedCallback(): void {
    ...
    this.subscribe(`equipment:${this.playerName}`, (equipment) => this.handleUpdatedEquipment(equipment as EquipmentItem[]));
  }
  ...
  handleUpdatedEquipment(equipment: EquipmentItem[]): void {
